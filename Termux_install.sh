...
cp -f url /data/data/com.termux/files/usr/bin/ShortUrl
echo 'kali/termux-open-url https://github.com/codingwithdevil/' > /data/data/com.termux/files/usr/bin/codingwithdevil
echo 'kali/termux-open-url https://github.com/codingwithdevil/' > /data/data/com.termux/files/usr/bin/CODINGWITHDEVIL
echo 'kali/termux-open-url https://www.instagram.com/codingwithdevil/' > /data/data/com.termux/files/usr/bin/instagram
echo 'kali/termux-open-url https://www.instagram.com/codingwithdevil/' > /data/data/com.termux/files/usr/bin/Instagram
chmod +x /data/data/com.termux/files/usr/bin/codingwithdevil
chmod +x /data/data/com.termux/files/usr/bin/CODINGWITHDEVIL
